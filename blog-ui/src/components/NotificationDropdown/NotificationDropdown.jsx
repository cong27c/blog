...
const NotificationDropdown = ({
  ...
  useEffect(() => {
    ...
    if (currentUserId) {
      channel = socketClient.subscribe(
        `private-notifications-${currentUserId}`
      );
    ...
    return () => {
      if (channel) {
        ...
        socketClient.unsubscribe(`private-notifications-${currentUserId}`);
      }
    };
                ...
                {notifications.slice(0, 10).map((notification) => (
                  ...
                  >
                    ...
                    <div className={styles.itemContent}>
                      <div className={styles.message}>{notification.title}</div>
